...
<li class="value"><input type="text" name="SQL:dbhost" value="<?echo $this->getParam("SQL:dbhost","localhost")?>"/></li>
</ul>
<ul class="formline">
<li class="label">Input DB Name</li>
<li class="value"><input type="text" name="SQL:dbname" value="<?echo $this->getParam("SQL:dbname","")?>"/></li>
</ul>
<ul class="formline">
