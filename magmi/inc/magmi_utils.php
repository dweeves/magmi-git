...
class Slugger
{
    ...
    protected static $_translit = array('Š'=>'S','š'=>'s','ś'=>'s','Ś'=>'S','Ð'=>'Dj','Ž'=>'Z','ž'=>'z','ż'=>'z',
        'Ż'=>'Z','ź'=>'z','Ź'=>'Z','À'=>'A','Á'=>'A','Â'=>'A','Ã'=>'A','Ä'=>'Ae','Å'=>'A','Æ'=>'A','ą'=>'a','Ą'=>'A',
        'Ç'=>'C','ć'=> 'c','Ć'=>'C','È'=>'E','É'=>'E','Ê'=>'E','Ë'=>'E','ę'=>'e','Ę'=>'E','Ì'=>'I','Í'=>'I','Î'=>'I',
        'Ï'=>'I','Ñ'=>'N','ń'=>'n','Ń'=>'N','Ò'=>'O','Ó'=>'O','Ô'=>'O','Õ'=>'O','Ö'=>'Oe','Ø'=>'O','Ù'=>'U','Ú'=>'U',
        'Û'=>'U','Ü'=>'Ue','Ý'=>'Y','Þ'=>'B','ß'=>'ss','à'=>'a','á'=>'a','â'=>'a','ã'=>'a','ä'=>'ae','å'=>'a','æ'=>'a',
        'ç'=>'c','è'=>'e','é'=>'e','ê'=>'e','ë'=>'e','ì'=>'i','í'=>'i','î'=>'i','ï'=>'i','ð'=>'o','ñ'=>'n','ò'=>'o',
        'ó'=>'o','ô'=>'o','õ'=>'o','ö'=>'oe','ø'=>'o','ù'=>'u','ú'=>'u','û'=>'u','ý'=>'y','þ'=>'b','ÿ'=>'y','ƒ'=>'f',
        'Č'=>'C','č'=>'c','Ľ'=>'L','ľ'=>'l','Ĺ'=>'L','ł'=>'l','Ł'=>'L','Ť'=>'T','ť'=>'t','Ň'=>'N','ň'=>'n','Ŕ'=>'R',
        'ŕ'=>'r','Ř'=>'R','ř'=>'r','Ő'=>'O','ő'=>'o','Ű'=>'U','ű'=>'u','ı'=>'i', 'İ'=>'I', 'ü'=>'ue', 'ş'=>'s', 'Ş'=>'S',
         'ğ'=>'g', 'Ğ'=>'G');
