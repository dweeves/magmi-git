...
<ul class="formline">
 ...
 <li class="value"><input type="text" id="IMG:remoteroot" name="IMG:remoteroot" style="width:500px" value="<?php echo $this->getParam("IMG:remoteroot","")?>">
 </li>
 </ul>
 ...
 <ul class="formline">
	 ...
	 <li class="value">
 	<input type="checkbox" id="IMG:remoteauth" name="IMG:remoteauth" <?php  if($this->getParam("IMG:remoteauth",false)==true){?>checked="checked"<?php }?>>authentication needed
 	</li>
 </ul>
 
 <div id="imgremoteauth" <?php  if($this->getParam("IMG:remoteauth",false)==false){?>style="display:none"<?php }?>>
 	<ul class="formline">
 		<li class="label">User</li>
 		<li class="value"><input type="text" name="IMG:remoteuser" id="IMG:remoteuser" value="<?php echo $this->getParam("IMG:remoteuser","")?>"></li>
 		
 	</ul> 
 	<ul class="formline">
 		<li class="label">Password</li>
 		<li class="value"><input type="text" name="IMG:remotepass" id="IMG:remotepass" value="<?php echo $this->getParam("IMG:remotepass","")?>"></li>
 	</ul> 
 </div>
</div>
