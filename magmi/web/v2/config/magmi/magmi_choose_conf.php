...
<ul class="nav nav-pills">
    <li class="<?php echo $custconf ? '' : 'active' ?>"><a href="javascript:void(0)" id="stdconf_btn">Standard
            (conf/magmi.ini)</a></li>
    <li class="<?php echo $custconf ? 'active' : '' ?>"><a href="javascript:void(0)" id="custconf_btn">Custom conf
            file</a></li>
</ul>
...
<div class="<?php echo !$custconf ? 'collapse' : '' ?>" id="magmi_custom_conf">
    <div class="input-group">
        ...
        <input type="text" id="magconf" name="magconf" class="form-control"
               placeholder="leave blank to reset to default" aria-describedby="magmiconf" value="<?php echo $cf ?>">
    </div>
</div>
